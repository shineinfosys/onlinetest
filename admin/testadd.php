...
{
extract($_POST);
mysqli_query($con,"insert into mst_test(sub_id,test_name,total_que, time) values ('$subid','$testname','$totque','$time')",$cn) or die(mysqli_error());
...
?>
    ...
    <tr>
        ...
        <td>&nbsp;</td>
	  <td><input class="form-control" name="testname" type="text" id="testname" placeholder="Enter Test paper name"></td>
    </tr>
    <tr>
      <td height="26"><div align="left"><strong>Enter Total Question </strong></div></td>
      <td>&nbsp;</td>
      <td><input class="form-control" name="totque" type="text" id="totque" placeholder="Enter no of question"></td>
    </tr>
    <tr>
      <td height="26"><div align="left"><strong>Time </strong></div></td>
      <td>&nbsp;</td>
      <td><input class="form-control" name="time" type="text" id="time" placeholder="Enter time in minutes"></td>
    </tr>
    <tr>
      <td height="26"></td>
      <td>&nbsp;</td>
