...
<div class="container">
	<div class="panel panel-default" style="display: flex;justify-content: center;">
	  <div class="panel-body">
	     <div class="card" id="online-exam-img" style="text-align:center;">
          <img class="card-img-top rounded mx-auto d-block" src="online_exam.jpg" style="max-height:200px;" alt="Online Exam">
          <div class="card-body">
            <p class="card-text"><h3>Welcome to Online Exam</h3></p>
            <p><a id="login-form-btn" style="margin-top: 10px;margin-bottom: 10px;" class="btn btn-primary" href="login.php" role="button"> Login! </a></p>
          </div>
        </div>
		...
		if(isset($submit))
		{
			...
			else
			{
				...
				function pageRedirect() {
                    window.location.replace("https://shineinfosys.com/onlinetest/index.php");
                }      
		...
		<style>
			...
			<div class="row">
	  		...
	  		<?php
				...
				{
				    ?>
				    <style>.card{display:none !important; }</style>
				    <?php
				    echo '<style>.online-exam-img{display:none;}</style>';
		            ...
		            echo '<img src="./image/noexam.png" />';
		            echo '<style>#online-exam-img{display:none;} #multiCollapseExample1{display:none;}</style>';
		        }
			?>
			  	</div>
			  </div>
	  ...
	  <div class="row d-flex justify-content-center">
	  	<div class="col-lg-4" style="<?php if($_GET['ref'] == 0){ echo 'display:none;';} ?>border: 1px solid #ddd;border-radius: 5px;padding: 20px;background: #fff;box-shadow: 1px 1px 8px 0px #888888;margin-top: 50px;">
	  	    <?php if($_GET['alert'] == 1){
